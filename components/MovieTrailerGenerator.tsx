    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            for (let b = 0; b < numBatches; b++) {
                ...
                - Scenes 1 to ${Math.ceil(targetSceneCount * 0.2)}: Opening conflict, heated arguments, and establishing the crisis.
                - Scenes ${Math.ceil(targetSceneCount * 0.2) + 1} to ${Math.floor(targetSceneCount * 0.7)}: Emotional breakdowns, deep struggle, character growth, and intense action/fight scenes.
                - Scenes ${Math.floor(targetSceneCount * 0.7) + 1} to ${targetSceneCount}: Turning point, eventual success, and a professional cinematic resolution.
                ...
                CRITICAL: Maintain 100% facial and outfit consistency for all characters.
                `;
