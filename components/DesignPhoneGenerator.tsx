...
const DesignPhoneGenerator: React.FC = () => {
    ...
    const handleGenerateImage = async (index: number) => {
        ...
        try {
            const prompt = `100% Realistic, professional macro photography of phone restoration, 8k. Action: ${scene.action}. Environment: ${scene.consistentContext}. Detailed textures of glass, metal, circuitry, fresh paint. Cinematic laboratory lighting.`;
                        ...
                        {localHistory.length > 0 ? (
                            localHistory.map((project, idx) => (
                                ...
                                >
                                    ...
                                    <p className="text-white text-xs font-bold truncate mb-1">Phone Content</p>
