...
const VipPlan: React.FC = () => {
  ...
  const handleOpenTelegram = () => {
    window.open('https://t.me/+FzsYy47aF2gxMDM1', '_blank');
  };
    ...
    <div className="w-full max-w-6xl mx-auto p-6 text-center animate-fade-in pb-24 font-sans">
      ...
      <div className="flex flex-wrap justify-center gap-2 mb-12 bg-[#1e293b]/40 p-1.5 rounded-2xl border border-gray-700/50 w-fit mx-auto shadow-2xl backdrop-blur-md">
        ...
        <button 
          ...
          className="px-8 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 bg-gradient-to-r from-[#eab308] to-[#ca8a04] text-black shadow-lg border border-yellow-400/50 hover:brightness-110"
        >
          <span className="text-lg">📚</span> មេរៀន VIP Class
        </button>
      </div>
